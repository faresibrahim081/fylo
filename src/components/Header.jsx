...
function Header() {
  ...
  return (
    <>
        <header ref={headerRef} className="flex justify-between items-center sm:gap-0 flex-col sm:flex-row px-[40px] pt-[60px] fixed top-0 left-0 w-full transition-all duration-300 z-50">
        <Link href="/">
